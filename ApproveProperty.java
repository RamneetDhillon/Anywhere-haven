...
public class ApproveProperty extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            if(rs.next())
            {
                ...
                SimpleMailDemo obj = new SimpleMailDemo(email, "Property Information", "Your property at " +address+" has been approved by Admin.");
                out.println("success");
            }
